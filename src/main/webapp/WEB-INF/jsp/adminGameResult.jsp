...
<div class="page" style="text-align: center">
    <ul class="pagination">
        ...
        <li><a href="admin/result?pageNum=1">首页</a>
        <li><a href="admin/result?pageNum=${pageInfo.prePage}">上一页</a>
            </c:when>
            <c:otherwise>
        ...
        <li class="active"
            ...
            <a href="admin/result?pageNum=${index}">${index}</a>

            </c:forEach>
            <c:choose>
            <c:when test="${pageInfo.hasNextPage}">
        <li><a href="admin/result?pageNum=${pageInfo.nextPage}">下一页</a>
        <li><a href="admin/result?pageNum=${pageInfo.pages}">尾页</a>
            </c:when>
            <c:otherwise>
