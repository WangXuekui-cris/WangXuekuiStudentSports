...
<body>
<form class="form-horizontal" role="form"  method="post" onsubmit="return checkForm()" action="admin/add">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="totalNum" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">赛事规则</label>
        <div class="col-sm-10">
            <textarea name="gameRule" class="form-control" rows="3"></textarea>
        </div>
    </div>
    <div class="form-group">
